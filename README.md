...
2. Press the Diffly button <img src="images/icon_v2-dark.png" width="18" alt="Diffly generate icon"> in the Source Control title bar (top-right of the Source Control view) — or run **Diffly: Generate Commit Message** from the Command Palette.
