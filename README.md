...
- Stage changes, then press the DiffSmith button <img src="images/icon-dark.png" width="18" alt="DiffSmith generate icon"> in the Source Control title bar (top-right of the Source Control view, next to the `…` menu) — or run **DiffSmith: Generate Commit Message** from the Command Palette (`Ctrl+Shift+P`).
